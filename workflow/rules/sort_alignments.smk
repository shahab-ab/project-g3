...
rule sort_alignments_denovo:
    input: "results/mapped_denovo/{sample}.bam"
    output: "results/sorted_denovo/{sample}.bam"
    log: "logs/sort_alignments_denovo/{sample}.log"
    threads: 8
    wrapper: "v1.21.1/bio/samtools/sort"

rule index_sorted_samples_denovo:
    input: "results/sorted_denovo/{sample}.bam",
    output: "results/sorted_denovo/{sample}.bam.bai",
